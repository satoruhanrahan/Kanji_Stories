<template>
  <div id="container">
    ...
    <div id="mainSection">
      ...
      <input type="password" placeholder="Password" v-model="password" v-on:keyup.enter="signup"/>
      <SignUpBtn id="signupBtn" v-on:click.native="signup" v-on:keyup.enter="signup"/>
